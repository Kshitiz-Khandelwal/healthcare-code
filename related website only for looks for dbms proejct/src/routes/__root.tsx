...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "CardioPredict — ECG Heart Disease Prediction" },
      { name: "description", content: "AI-powered ECG analytics with full MySQL DBMS integration." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "CardioPredict — ECG Heart Disease Prediction" },
      { property: "og:description", content: "AI-powered ECG analytics with full MySQL DBMS integration." },
